...
RECT_COLOR = {
    "intervention_ci_long": "#b29",
    "intervention_uc_long": "#3ab",
}
...
plt.savefig(f"computed/figures_video/trust_{args.queue}.svg")
plt.show()

# ./src_analysis/plot_trust_video.py -q control_long
# ./src_analysis/plot_trust_video.py -q intervention_ci_long --rect
# ./src_analysis/plot_trust_video.py -q intervention_uc_long --rect